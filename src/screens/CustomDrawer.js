  ...
  function CustomDrawerContent(props) {
    return (
      <DrawerContentScrollView {...props}>
        <DrawerItem label={()=>(<Image source={require('../img/iconapp.png')}/>)} style={{marginVertical:50}} />
        ...
        <View style={{flexDirection:'row'}}>
          ...
          <FontAwesome name="twitter" size={24} color="white" style={{margin:10}} onPress={()=>Linking.openURL('https://twitter.com/Wiggle_Tunes')} />
          ...
          <FontAwesome name="instagram" size={24} color="white" style={{margin:10}} onPress={()=>Linking.openURL('https://www.instagram.com/wiggle_tunes/')}/>
